...
void MenubarManager::setupMenubar(QQuickWindow *view, DeviceManager *dm)
{
    ...
    m_actionAbout = new QAction(tr("About Lighthouse"));
...
{
    QDesktopServices::openUrl(QUrl("https://emeric.io/Lighthouse"));
}

void MenubarManager::issuetracker()
{
    QDesktopServices::openUrl(QUrl("https://github.com/emericg/Lighthouse/issues"));
}

void MenubarManager::releasenotes()
{
    QDesktopServices::openUrl(QUrl("https://github.com/emericg/Lighthouse/releases"));
}
