    ...
    contentItem: Item {
        Column {
            ...
            Text {
                ...
                text: qsTr("Are you sure you want to do that?")
            ...
            Text {
                ...
                text: qsTr("This action is an action. Action carefully. There will be no un-actionning. Or maybe there will be?")
                textFormat: Text.PlainText
            ...
            Flow {
                ...
                ButtonFlat {
                    ...
                    text: qsTr("Cancel")
                    onClicked: popupConfirmation.close()
                }
